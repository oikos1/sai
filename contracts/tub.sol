...
contract SaiTub is DSThing, SaiTubEvents {
    ...
    event Debug(bytes32 title, uint x, uint y);
    event Bite(bytes32 indexed cup, address lad, uint256 ink, uint256 art, uint256 ire, address guy);
    event Free(bytes32 indexed cup, uint wad, address lad, uint256 ink, uint256 art, uint256 ire, address guy);
    event Lock(bytes32 indexed cup, uint wad, address lad, uint256 ink, uint256 art, uint256 ire, address guy);
    event Draw(bytes32 indexed cup, uint wad, address lad, uint256 ink, uint256 art, uint256 ire, address guy);
    event Wipe(bytes32 indexed cup, uint wad, address lad, uint256 ink, uint256 art, uint256 ire, address guy);
    event Shut(bytes32 indexed cup, address lad, uint256 ink, uint256 art, uint256 ire, address guy);
    event Give(bytes32 indexed cup, address lad, uint256 ink, uint256 art, uint256 ire, address guy);
   ...
   //--Price-feed-setters----------------------------------------------
    ...
    function give(bytes32 cup, address guy) public note {
        ...
        require(guy != 0);
        cups[cup].lad = guy;
        Give(cup, cups[cup].lad, cups[cup].ink, cups[cup].art, cups[cup].ire, msg.sender);
    ...
    function lock(bytes32 cup, uint wad) public note {
        ...
        require(cups[cup].ink == 0 || cups[cup].ink > 5 sun);
        Lock(cup, wad, cups[cup].lad, cups[cup].ink, cups[cup].art, cups[cup].ire, msg.sender);
    }
    ...
    function free(bytes32 cup, uint wad) public note {
        ...
        require(safe(cup));
        require(cups[cup].ink == 0 || cups[cup].ink > 5 sun);
        Free(cup, wad, cups[cup].lad, cups[cup].ink, cups[cup].art, cups[cup].ire, msg.sender);
    }
    ...
    function shut(bytes32 cup) public note {
        ...
        Shut(cup, cups[cup].lad, cups[cup].ink, cups[cup].art, cups[cup].ire, msg.sender);
        delete cups[cup];
    }
    ...
    function bite(bytes32 cup) public note {
        ...
        Bite(cup, cups[cup].lad, cups[cup].ink, cups[cup].art, cups[cup].ire, msg.sender);
